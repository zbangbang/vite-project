...
import { createTextbox } from '@/utils/editor/objects/textbox';
import { getSystemClipboard } from './index';
import { createFImage } from '@/utils/editor/objects/image';
import { handleMouseOutCorner } from '@/utils/editor/controller';
