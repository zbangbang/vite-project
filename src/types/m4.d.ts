...
declare const m4: {
   ...
   */
  setDefaultType(Ctor: TypedArray);
   ...
   * @memberOf module:webgl-3d-math
   */
  cross(a: Vector3, b: Vector3, dst?: Vector3): number;
  ...
  quatFromRotationMatrix(m, dst?: Matrix4): Matrix4;

  decompose(mat: Matrix4, translation: number[], quaternion: Matrix4, scale: number[]);

  determinate(m: Matrix4): number;
